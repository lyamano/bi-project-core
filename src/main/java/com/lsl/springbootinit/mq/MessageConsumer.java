package com.lsl.springbootinit.mq;
...
import com.lsl.springbootinit.ws.WebSocketServer;
...
import static com.lsl.springbootinit.mq.MqConstant.QUEUE_NAME;
...
public class MessageConsumer {
    ...
    public void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
        ...
        String result = aiManager.doChat(biModelId,handleUserInput(chart));
        log.error("分析完了");
